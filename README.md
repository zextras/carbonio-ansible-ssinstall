...
```
ansible-playbook -i inventoryname playbooks/carbonio_ansible_ssinstall.yml  --extra-vars "install_path=/path/to/carbonio-install-ansible/carbonio-install/carbonio-install.yml"
```
...
ansible-playbook -i inventoryname playbooks/carbonio_ansible_ssinstall.yml  --extra-vars "install_path=zxbot.carbonio_install.carbonio_install"
```
